...
export const DiscountSettings: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-10 space-y-12 animate-in fade-in duration-700" dir="rtl">
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 pb-4 border-b border-slate-100">
        <div>
          ...
          <p className="text-slate-400 font-bold uppercase tracking-[0.3em] text-xs">
            تحديد الحسابات المالية الافتراضية لعمليات الخصم
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <h3 className="font-black text-xl text-slate-800 tracking-tight">خصم العملاء (مسموح به)</h3>
              </div>
              <p className="text-sm text-slate-400 font-medium leading-relaxed px-1">
                اختر الحساب الذي سيتم تحميل قيمة الخصم الممنوح للعملاء عليه. غالباً ما يكون حساب "خصم مسموح به".
              </p>
              <div className="relative group">
                <BookOpen className="absolute right-5 top-5 text-slate-300 group-focus-within:text-emerald-500 transition-colors pointer-events-none" size={24} />
                <select
                  className="w-full pr-14 pl-6 py-5 bg-slate-50 border border-slate-100 rounded-[2rem] text-xl font-black text-slate-900 appearance-none outline-none focus:bg-white focus:ring-8 focus:ring-emerald-500/5 focus:border-emerald-500/50 transition-all shadow-inner"
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <h3 className="font-black text-xl text-slate-800 tracking-tight">خصم الموردين (مكتسب)</h3>
              </div>
              <p className="text-sm text-slate-400 font-medium leading-relaxed px-1">
                اختر الحساب الذي سيتم قيد قيمة الخصم المكتسب من الموردين فيه. غالباً ما يكون حساب "خصم مكتسب".
              </p>
              <div className="relative group">
                <BookOpen className="absolute right-5 top-5 text-slate-300 group-focus-within:text-amber-500 transition-colors pointer-events-none" size={24} />
                <select
                  className="w-full pr-14 pl-6 py-5 bg-slate-50 border border-slate-100 rounded-[2rem] text-xl font-black text-slate-900 appearance-none outline-none focus:bg-white focus:ring-8 focus:ring-amber-500/5 focus:border-amber-500/50 transition-all shadow-inner"
        ...
        <div className="bg-emerald-600 p-10 rounded-[3rem] text-white shadow-2xl relative overflow-hidden group">
          ...
          <div className="relative z-10 space-y-6">
            <div className="flex items-center gap-4">
              ...
              <h4 className="text-2xl font-black tracking-tight">لماذا نحدد هذه الحسابات؟</h4>
            </div>
            <p className="text-emerald-50 font-medium leading-relaxed text-lg italic serif">
              ...
              حيث يتم استخدامها كطرف في القيود لضمان صحة ميزان المراجعة والتقارير المالية.
            </p>
          </div>
        </div>
