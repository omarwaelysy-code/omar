...
export const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted, onLogin }) => {
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans antialiased overflow-x-hidden" dir="ltr">
      {/* Sticky Navbar Header with Glassmorphism */}
      <LandingHeader onGetStarted={onGetStarted} />

      {/* Main Hero Container */}
      <main className="w-full max-w-[1340px] mx-auto px-6 sm:px-10 lg:px-14 pt-6 lg:pt-10 pb-20 min-h-[calc(100vh-100px)] flex flex-col justify-center relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center relative">
          ...
          {/* Right Column - Hero Visual Graphic (Increased size, improved spacing & soft shadow) */}
          <motion.div 
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
