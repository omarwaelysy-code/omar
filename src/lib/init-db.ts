...
export async function initDatabase() {
  ...
  try {
    ...
    await safeQuery(`ALTER TABLE "issued_cheques" ALTER COLUMN "supplier_id" DROP NOT NULL;`, 'alter supplier_id drop not null in issued_cheques');
    ...
    await safeQuery(`CREATE INDEX IF NOT EXISTS "idx_issued_cheques_type" ON "issued_cheques"("company_id", "cheque_type");`, 'idx_issued_cheques_type');
    await safeQuery(`CREATE INDEX IF NOT EXISTS "idx_issued_cheques_debit_account" ON "issued_cheques"("company_id", "debit_account_id");`, 'idx_issued_cheques_debit_account');
    ...
    `, 'received_cheques table');

    await safeQuery(`CREATE INDEX IF NOT EXISTS "idx_received_cheques_company_status" ON "received_cheques"("company_id", "status");`, 'idx_received_cheques_company_status');
    await safeQuery(`CREATE INDEX IF NOT EXISTS "idx_received_cheques_due_date" ON "received_cheques"("company_id", "due_date");`, 'idx_received_cheques_due_date');
    await safeQuery(`CREATE INDEX IF NOT EXISTS "idx_received_cheques_customer" ON "received_cheques"("company_id", "customer_id");`, 'idx_received_cheques_customer');
    await safeQuery(`CREATE INDEX IF NOT EXISTS "idx_received_cheques_cheque_number" ON "received_cheques"("company_id", "cheque_number");`, 'idx_received_cheques_cheque_number');
    await safeQuery(`CREATE INDEX IF NOT EXISTS "idx_received_cheques_receipt_number" ON "received_cheques"("company_id", "receipt_number");`, 'idx_received_cheques_receipt_number');
    await safeQuery(`CREATE INDEX IF NOT EXISTS "idx_received_cheques_serial_number" ON "received_cheques"("company_id", "serial_number");`, 'idx_received_cheques_serial_number');
    await safeQuery(`CREATE INDEX IF NOT EXISTS "idx_received_cheques_type" ON "received_cheques"("company_id", "cheque_type");`, 'idx_received_cheques_type');
    await safeQuery(`CREATE INDEX IF NOT EXISTS "idx_received_cheques_debit_account" ON "received_cheques"("company_id", "debit_account_id");`, 'idx_received_cheques_debit_account');
    await safeQuery(`CREATE INDEX IF NOT EXISTS "idx_received_cheques_credit_account" ON "received_cheques"("company_id", "credit_account_id");`, 'idx_received_cheques_credit_account');
