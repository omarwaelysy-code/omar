...
export async function runMigrations() {
  ...
  try {
    ...
    const columnsToSync = [
      ...
      { table: 'products', column: 'purchase_vat_rate', type: 'DECIMAL(10,4) DEFAULT 14' },
      { table: 'products', column: 'sales_withholding_tax_account_id', type: 'VARCHAR(36)' },
      { table: 'products', column: 'sales_withholding_tax_account_name', type: 'VARCHAR(255)' },
      { table: 'products', column: 'sales_withholding_tax_rate', type: 'DECIMAL(10,4) DEFAULT 0' },
      { table: 'products', column: 'purchase_withholding_tax_account_id', type: 'VARCHAR(36)' },
      { table: 'products', column: 'purchase_withholding_tax_account_name', type: 'VARCHAR(255)' },
      { table: 'products', column: 'purchase_withholding_tax_rate', type: 'DECIMAL(10,4) DEFAULT 0' },
      { table: 'invoices', column: 'withholding_tax_amount', type: 'DECIMAL(18,4) DEFAULT 0' },
      { table: 'invoice_items', column: 'withholding_tax_rate', type: 'DECIMAL(10,4) DEFAULT 0' },
      { table: 'invoice_items', column: 'withholding_tax_amount', type: 'DECIMAL(18,4) DEFAULT 0' },
      { table: 'purchase_invoices', column: 'withholding_tax_amount', type: 'DECIMAL(18,4) DEFAULT 0' },
      { table: 'purchase_invoice_items', column: 'withholding_tax_rate', type: 'DECIMAL(10,4) DEFAULT 0' },
      { table: 'purchase_invoice_items', column: 'withholding_tax_amount', type: 'DECIMAL(18,4) DEFAULT 0' },
      { table: 'returns', column: 'withholding_tax_amount', type: 'DECIMAL(18,4) DEFAULT 0' },
      { table: 'return_items', column: 'withholding_tax_rate', type: 'DECIMAL(10,4) DEFAULT 0' },
      { table: 'return_items', column: 'withholding_tax_amount', type: 'DECIMAL(18,4) DEFAULT 0' },
      { table: 'purchase_returns', column: 'withholding_tax_amount', type: 'DECIMAL(18,4) DEFAULT 0' },
      { table: 'purchase_return_items', column: 'withholding_tax_rate', type: 'DECIMAL(10,4) DEFAULT 0' },
